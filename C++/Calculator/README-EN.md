# Calculator.cpp Documentation
  This README serves to show some documentation as to how the calculator works. It contains sample inputs so you can understand how to properly input problems and also shows some patch notes for previous versions.
...
## Tutorial
  ...
  You can also type "1" or "2" for either "Help", which shows another small tutorial on how to use the calculator, or to toggle "Debug" which will output some extra information on how the problem is being handled.
...
## Patch Notes
    ...
    28/05/25|V1.3
    -Started reworking the entire calculation pipeline to make it more optimised and easier to rework. Currently can't actually calculate anything
    ...
    -Removed the complexCalculations bool setting in the menu as this new design only calculates it if it is present. All mentions of complexCalculation have been archived and will mostlikely be removed later down the line
